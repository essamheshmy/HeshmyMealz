...
//@Inject constructor(private val getMealsUseCase: GetMealz)
    :ViewModel(){
    ...
    fun getMealsUseCase()=GetMealz(MealsRepoImpl(apiService()))

    fun getMeals()={
       viewModelScope.launch {
           try {
               _categories.value= getMealsUseCase().invoke()//.categories
    }catch (e:Exception){
